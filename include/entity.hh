...
class CEntity
{
  ...
  // distinct from the player types found in messages.h
  ...
  private: double vx, vy, vth;

  // Mass of the entity (for collision calculations)
  ...
  // What the hel is this? AH
  public: double dx, dy;

  // End collision related stuff
  //////////////////////////////////////////////////////////////////////
