...
% Date: 10 Jun 2002
% CVS: $Id: stage.tex,v 1.20 2004-07-16 19:06:56 rtv Exp $
...
\begin{itemize}
\item Documentation, including this manual and release notes.
\item C source code for 'stage' the simulation engine.
\item C and C++ code for the 'libStage' client library.    
\item Example worldfiles and bitmaps
\end{itemize}
