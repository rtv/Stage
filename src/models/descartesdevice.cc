...
// Constructor
//
CDescartesDevice::CDescartesDevice(LibraryItem* libit,CWorld *world, CEntity *parent)
  : CPositionDevice( libit, world, parent )
{    
  //puts( "DESCARTES" );
...
void CDescartesDevice::Servo()
{
  ...
  double heading_error = goalheading - odo_pa;
...
void CDescartesDevice::ComposeData()
{
    ...
    double pth = RTOD(fmod(odo_pa + TWOPI, TWOPI));
