...
//
// CVS info:
//  $Source: /home/tcollett/stagecvs/playerstage-cvs/code/stage/src/models/descartesdevice.hh,v $
//  $Author: rtv $
//  $Revision: 1.3 $
//
// Usage:
...
class CDescartesDevice : public CPositionDevice
{
  // Minimal constructor
  //
 public: CDescartesDevice( LibraryItem *libit, CWorld *world, CEntity *parent );
 
  // a static named constructor - a pointer to this function is given
  // to the Library object and paired with a string.  When the string
  // is seen in the worldfile, this function is called to create an
  // instance of this entity
public: static CDescartesDevice* Creator(   LibraryItem *libit, CWorld *world, CEntity *parent )
  { return( new CDescartesDevice( libit, world, parent ) ); }
