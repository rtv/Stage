...
IF(PROJECT_PROC_64BIT AND EXISTS "/etc/redhat-release") 
    # Set the install path to lib64
    SET(LIB_SUFFIX "64")
ELSE (PROJECT_PROC_64BIT AND EXISTS "/etc/redhat-release")
    SET(LIB_SUFFIX "")
ENDIF (PROJECT_PROC_64BIT AND EXISTS "/etc/redhat-release")
