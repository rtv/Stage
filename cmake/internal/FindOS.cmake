...
IF(PROJECT_PROC_64BIT AND EXISTS "/lib64" AND NOT EXISTS "/etc/debian_version")
    SET(LIB_SUFFIX "64")
ELSE (PROJECT_PROC_64BIT AND EXISTS "/lib64" AND NOT EXISTS "/etc/debian_version")
    SET(LIB_SUFFIX "")
ENDIF (PROJECT_PROC_64BIT AND EXISTS "/lib64" AND NOT EXISTS "/etc/debian_version")

SET(PROJECT_LIB_DIR "lib${LIB_SUFFIX}")
SET(PROJECT_PLUGIN_DIR "lib${LIB_SUFFIX}/${PROJECT_NAME}-${APIVERSION}")

MESSAGE(STATUS "Installing Stage libraries to ${CMAKE_INSTALL_PREFIX}/${PROJECT_LIB_DIR}")
MESSAGE(STATUS "Installing Stage plugin controllers to ${CMAKE_INSTALL_PREFIX}/${PROJECT_PLUGIN_DIR}")
